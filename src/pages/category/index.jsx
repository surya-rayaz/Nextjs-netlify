...
import AddCategory from "page-sections/category/AddCategory";
...
const Categorylist = () => {
  ...
  const getCategorys = async (value) => {
  ...
  const getarray = (newValue) => {
    ...
    setResponse("Category Added Sucessfully")

  };

  const UpdateCategory = () => {
    setResponseModal(true)
    setResponse("Category Updated Sucessfully")
    setEditModal(false)
  ...
  const DeleteCategory = () => {
    setResponseModal(true)
    setResponse("Category Deleted Sucessfully")
  ...
  return <Box pt={2} pb={4}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <FlexBox justifyContent="space-between" flexWrap="wrap">
            <SearchInput bordered={false} placeholder="Find Category" sx={{
            ...
            <AddCategory response={(value) => getarray(value)} open={openModal} checktype={checktype} setOpen={setOpenModal} />
          </FlexBox>
        </Grid>
      </Grid>
    ...
    <StyledAppModal open={editModal} handleClose={() => setEditModal(false)}>
      <Box mb={2}>
        <H6 mb={1}>Update Category</H6>
        <AppTextField value={coutername} onChange={(e) => setcoutername(e.target.value)} fullWidth size="small" placeholder="Category name" />
      ...
      <FlexBox mt={4} gap={2}>
        <Button variant="contained" fullWidth onClick={() => UpdateCategory()}>
          Update
        </Button>
    ...
    <StyledAppModal open={deletepopup} handleClose={() => setdeletepopup(false)}>
      ...
      <FlexBox mt={4} gap={2}>
        <Button style={{ backgroundColor: "red" }} variant="contained" fullWidth onClick={() => DeleteCategory()}>
          Yes
        </Button>
...
Categorylist.getLayout = getLayout; // ==============================================================
